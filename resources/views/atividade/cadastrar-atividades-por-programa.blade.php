...
@section('content')
	<div class="row">
		<div class="col-md-6 col-sm-8">
			<form class="form" name="form-cadastro-atividade-por-programa" id="form-cadastro-atividade-por-programa" action="{{ route('cria-atividade-por-programa') }}" method="POST">
